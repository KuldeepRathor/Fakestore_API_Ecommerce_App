import 'package:fakestore_api_ecommerce_platform/model/network/Network.dart';
import 'package:fakestore_api_ecommerce_platform/model/products/products.dart';
import 'package:fakestore_api_ecommerce_platform/model/singin/singin.dart';
import 'package:fakestore_api_ecommerce_platform/model/token/token.dart';
import 'package:get/get.dart';

abstract class FSGetXController extends GetxController {
  Future<JsonResponseToken> postToken(endPoint,
  ...
  Future<JsonResponseSingIn> postSingIn(endPoint,
      {Map<String, dynamic> params = const {}}) async {
  ...
  Future<JsonResponseList> getProductos(endPoint,
      {Map<String, dynamic> params = const {}}) async {
    JsonResponseList response = JsonResponseList();
    final network = Network();
    final JsonObjectResponse responseJson =
        await network.get(endPoint, params: params);
